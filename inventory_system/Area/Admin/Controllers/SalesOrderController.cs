...
namespace YourProject.Areas.Admin.Controllers
{
    ...
    public class SalesOrderController : Controller
    {
        ...
        // GET: Admin/SalesOrder/Details/5
        [HttpGet("Details/{id}")]
        ...
        // POST: Admin/SalesOrder/Delete/5
        [HttpPost("Delete/{id}")]
        [ValidateAntiForgeryToken]
