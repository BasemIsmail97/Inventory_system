...
namespace YourProject.Areas.Employee.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        // GET: Employee/Category/Details/5
        [HttpGet("Details/{id}")]
        ...
        // GET: Employee/Category/Delete/5
        [HttpGet("Delete/{id}")]
        ...
        // POST: Employee/Category/Delete/5
        [HttpPost("Delete/{id}")]
        [ValidateAntiForgeryToken]
