...
namespace YourProject.Areas.Employee.Controllers
{
    ...
    public class SupplierController : Controller
    {
        ...
        // GET: Employee/Supplier/Details/5
        [HttpGet("Details/{id}")]
        ...
        // GET: Employee/Supplier/Delete/5
        [HttpGet("Delete/{id}")]
        ...
        // POST: Employee/Supplier/Delete/5
        [HttpPost("Delete/{id}")]
        [ValidateAntiForgeryToken]
