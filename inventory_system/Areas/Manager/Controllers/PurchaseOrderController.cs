...
namespace YourProject.Areas.Manager.Controllers
{
    ...
    public class PurchaseOrderController : Controller
    {
        ...
        // GET: Manager/PurchaseOrder/Details/5
        [HttpGet("Details/{id}")]
        ...
        // GET: Manager/PurchaseOrder/Create
        [HttpGet("Create")]
        ...
        // POST: Manager/PurchaseOrder/Create
        [HttpPost("Create")]
        ...
        // GET: Manager/PurchaseOrder/Edit/5
        [HttpGet("Edit/{id}")]
        ...
        // POST: Manager/PurchaseOrder/Edit/5
        [HttpPost("Edit/{id}")]
        [ValidateAntiForgeryToken]
        ...
        // GET: Manager/PurchaseOrder/Delete/5
        [HttpGet("Delete/{id}")]
        ...
        // POST: Manager/PurchaseOrder/Delete/5
        [HttpPost("Delete/{id}")]
        [ValidateAntiForgeryToken]
